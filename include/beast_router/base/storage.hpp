        ...
        template <
            ...
            std::enable_if_t<
                utility::is_all_true_v<
                    (
                        std::is_invocable_v<OnRequest, const message_type&, context_type&, const std::smatch&> || std::is_invocable_v<OnRequest, const message_type&, context_type&> || std::is_invocable_v<OnRequest, context_type&>)...> && sizeof...(OnRequest) >= 1,
                bool> = true>
    ...
    private:
        ...
        struct callback_impl : callback {
            ...
            template <
                class F = Func,
                std::enable_if_t<
                    std::is_invocable_v<F, const message_type&, context_type&, const std::smatch&>, bool> = true>
            ...
            template <
                class F = Func,
                std::enable_if_t<
                    std::is_invocable_v<F, const message_type&, context_type&>, bool> = true>
            callback_impl(Func&& func)
            {
                m_func = std::bind<return_type>(
                    std::forward<Func>(func),
            ...
            template <
                class F = Func,
                std::enable_if_t<
                    std::is_invocable_v<F, context_type&>, bool> = true>
            callback_impl(Func&& func)
            {
                m_func = std::bind<return_type>(
                    std::forward<Func>(func),
