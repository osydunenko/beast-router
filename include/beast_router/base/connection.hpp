...
#define BASE_CONNECTION_TEMPLATE_ATTRIBUTES \
    Derived, CompletionExecutor
...
public:
     ...
     * @param func The handler to be called right after the connection is established
     * The equivalent function signature of the handler must be as the folowing:
     * @code
     * handler(boost::system::error_code &error, const EndpoitSequence &endpoints);
     * @endcode
     * @returns void
     */
