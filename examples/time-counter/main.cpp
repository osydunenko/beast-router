...
int main(int, char **)
{
    ...
    ::router.get(R"(^.*\.(js|html|css)$)", 
        [](const server_session::message_type &rq, server_session::context_type &ctx) {
    ...
    ::router.get(R"(^/$)", [](const server_session::message_type &rq, server_session::context_type &ctx) {
        ctx.send(make_moved_response(rq.version(), "/index.html"));
    });

    /// Handle the "update" request
    ::router.get(R"(^/update$)", [](const server_session::message_type &rq, server_session::context_type &ctx) {
